...
export function PipelineList({ onSelectPipeline, onCreatePipeline }: PipelineListProps) {
  const { 
    data: pipelinesData, 
    isLoading, 
    error, 
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">ML Pipeline Thing</h1>
            <p className="text-gray-600 mt-1">Manage and monitor your machine learning workflows</p>
          </div>
          <Button 
      ...
      {isLoading ? (
            ...
            <CardHeader className="pb-3">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-lg text-gray-900">{pipeline.name}</CardTitle>
                </div>
        ...
        {pipelines.length === 0 && (
          <div className="col-span-full text-center py-12">
            ...
            <p className="text-gray-500 mb-4">Get started by creating your first ML pipeline</p>
